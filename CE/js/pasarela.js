	...
	switch (product){
		...
		case 1:
			...
			if(carritoArray.indexOf("Nikon D5300 24MP") == -1){
				...
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"item_name_"+ carritoArray.length +"\" value=\"Nikon D5300 24MP\">";
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"amount_" + carritoArray.length +"\" value=\"639.00\">";
			}
		break;
		...
		case 2:
			if(carritoArray.indexOf("Verbatin Portable HHD") == -1){
				...
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"item_name_"+ carritoArray.length +"\" value=\"Verbatin Portable HHD\">";
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"amount_" + carritoArray.length +"\" value=\"79.95\">";
			}
		break;
		...
		case 3:
			if(carritoArray.indexOf("Sony Xperia M4") == -1){
				...
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"item_name_"+ carritoArray.length +"\" value=\"Sony Xperia M4\">";
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"amount_" + carritoArray.length +"\" value=\"228.00\">";
			}
		break;
		...
		case 4:
			if(carritoArray.indexOf("MSI GeForce Gtx 960") == -1){
				...
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"item_name_"+ carritoArray.length +"\" value=\"MSI GeForce Gtx 960\">";
				carrito_out.innerHTML += "<input type=\"hidden\" name=\"amount_" + carritoArray.length +"\" value=\"270.00\">";
			}
		break;
